        ...
        <div class="form-wrapper">
            ...
            <form method="post" action="{{ url('/users/edit') }}" enctype="multipart/form-data">
                ...
                <div class="form-item">
                    ...
                    <input id="email" type="email" placeholder="{{ $user->email }}" class="form-control @error('email') is-invalid @enderror" 
                        name="email" value="{{ $user->email }}"required autocomplete="email">
                </div>
                <div class="form-item">
                    <div style="text-align: left">プロフィール</div>

                    <textarea id="profile" type="text" placeholder="{{ $user->profile }}" name="profile" value="{{ $user->profile }}"></textarea>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <input id="youtube" type="text" placeholder="{{ $user->youtube }}" name="youtube" value="{{ $user->youtube }}">
                </div>
